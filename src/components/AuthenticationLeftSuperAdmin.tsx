...
const AuthenticationLeftSuperAdmin = () => {
    ...
    const handleSubmit = async(e: FormEvent<HTMLFormElement>) => {
        try {
            ...
            const userLog = await axios.post(`${process.env.REACT_APP_BASE_URL}/superadmin/login`, formData);
...
export default AuthenticationLeftSuperAdmin;
